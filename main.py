...
FLAGS = flags.FLAGS
flags.DEFINE_string("cfg", 'configs/meta/ant_dir/rnn.yml', "path to configuration file")
flags.DEFINE_string("env", None, "env_name")
flags.DEFINE_string("algo", 'td3', '["td3", "sac", "sacd"]')
...
flags.DEFINE_integer("cuda", 0, "cuda device id")
